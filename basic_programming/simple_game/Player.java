...
public class Player
{
    ...
    private Stack<Room> recentRoom;    // 최근에 있던 방
    ...
    public void moveTo(Room newRoom) {
        if (newRoom == null) {
            ...
            recentRoom.push(currentRoom);   // 지금 있는 방을 기억해 둠.
